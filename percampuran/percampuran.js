...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'percampuran.data';
      var REMOTE_PACKAGE_BASE = 'percampuran.data';
    ...
    function runWithFS() {
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_percampuran.data');

      };
      Module['addRunDependency']('datafile_percampuran.data');
    ...
    loadPackage({"files": [{"filename": "/icon48.png", "start": 0, "end": 2086}], "remote_package_size": 2086, "package_uuid": "70fb22b3-1cdd-4e46-abbd-26bc761cf4f8"});
...
var wasmBinaryFile;
  wasmBinaryFile = 'percampuran.wasm';
...
var ASM_CONSTS = {
  ...
  function _glfwGetJoystickName(joy) {
      if (GLFW.joys[joy]) {
  ...
  function _glfwSetJoystickCallback(cbfun) {
